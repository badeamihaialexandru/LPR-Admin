...
class CheckboxTreeview(ttk.Treeview):
    ...
    def __init__(self, master=None, **kw):
        ...
        self.heading("nume",text="Nume",anchor="w")
        self.heading("prenume",text="Prenume",anchor="w")
        self.heading("functie",text="Functie",anchor="w")
        self.heading("numar",text="Numar",anchor="w")

        self.column("#0",width=50)
        self.column("nume",width=100)
        self.column("prenume",width=100)
        self.column("functie",width=100)
        self.column("numar",width=100)
